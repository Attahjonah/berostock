...
//     .text('Product', 50, y, { width: 90 })
//     .text('Description', 145, y, { width: 140 })
//     .text('Qty', 295, y, { width: 40, align: 'right' })
//     .text('Rate', 345, y, { width: 70, align: 'right' })
//     .text('Amount', 430, y, { width: 80, align: 'right' })
...
//     doc
//         .text(prod.name, 50, y, { width: 90 })
//         .text(prod.description || '-', 145, y, { width: 140 })
//         .text(item.quantity.toString(), 295, y, { width: 40, align: 'right' })
//         .text(`₦${prod.selling_price.toLocaleString()}`, 345, y, { width: 70, align: 'right' })
//         .text(`₦${amount.toLocaleString()}`, 430, y, { width: 80, align: 'right' });
...
//     .text('TOTAL:', 350, y)
//     .text(`₦${sale.total_price.toLocaleString()}`, 430, y);

//   y += rowHeight;
//   doc.font('Helvetica')
//    .text(`Amount in words: ${writtenNumber(sale.total_price)} naira only`, 50, y);

//   // QR Code
//   const qrBuffer = await QRCode.toBuffer(sale.sale_id);
//   doc.image(qrBuffer, 50, y + 40, { width: 80 });
...
//   doc.font('Helvetica-Bold')
//     .text('TOTAL:', 360, y)
//     .text(`₦${sale.total_price.toLocaleString()}`, 450, y);
